    ...
    <nav class="navbar navbar-expand-lg navbar-light container" style="background-color: #121D3F;">
        <div class="d-flex w-100">
            ...
            <ul class="navbar-nav mx-auto align-self-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="compteUtilisateur.php" title="Compte"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
